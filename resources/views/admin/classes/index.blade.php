        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Классы</h5>
                </div>
        ...
        <div class="card-body pt-0">
            <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel"
                    ...
                    <div id="tableExample" data-list='{"valueNames":["name","email","age" , "edit"],"page":5,"pagination":true}'>
                        <div class="table-responsive scrollbar">
                            <table class="table table-bordered table-striped fs--1 mb-0">
                                <thead class="bg-200 text-900">
                                <tr>
                                    <th class="sort" data-sort="name">Name</th>
                                    <th class="sort" data-sort="login">Classroom Teacher</th>
                                ...
                                @foreach($classes as $class)
                                    <tr>
                                        <td name="name" cope="row">
                                            {{ $class->name }}
                                        </td>
                                        <td name="login">{{ $class->teacher->login }}</td>
                                        <td name="age">
                                        ...
                                        <td name="edit" >
                                            <a href="{{ route("admin.classes.edit" , $class->id)}}">
                                                <button class="btn btn-outline-primary align-self-center" type="button">
                                                    Edit
                                                </button>
                                            </a>
                                        </td>
