        ...
        <div class="card-header">
            <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                    <a href="{{ route("admin.photo-gallery.archive") }}" class="hover-text-decoration-none me-3">
                        Архив
                    </a>
                    ...
                    <div class="col-3 p-2">
                        <a class="color-white" href="#!">
                            <div class="hoverbox rounded-3 p-0">
                                ...
                                <div class="light hoverbox-content bg-dark p-3 flex-center">
                                    <div class="p-0 m-0 text-center">
                                        <p class=" text-white">{{ $photo->description}}</p>
                                        {!! Form::open(['route' => ['admin.photo-gallery.destroy', $photo->id], 'method' => 'DELETE']) !!}
                                        {!! Form::submit('Архивировать', ['class' => 'btn btn-danger btn-sm mt-1']) !!}
                                        {!! Form::close() !!}
                                    </div>
                                </div>
                            </div>
