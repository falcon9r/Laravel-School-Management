...
<head>
    ...
    <script src="{{ asset('vendor/overlayscrollbars/OverlayScrollbars.min.js') }}"></script>
    ...
    <link
        ...
        rel="stylesheet">
    @yield('before_css')
    <link href="{{ asset('vendor/overlayscrollbars/OverlayScrollbars.min.css') }}" rel="stylesheet">
