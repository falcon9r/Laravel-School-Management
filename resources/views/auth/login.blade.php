            ...
            <div class="row min-vh-100 flex-center g-0">
                <div class="col-lg-8 col-xxl-5 py-3 position-relative">
                    <img class="bg-auth-circle-shape"
                         src="{{ asset('assets/img/icons/spot-illustrations/bg-shape.png') }}" alt="" width="250">
                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form action="{{ route('login')  }}" method="post">
                                            @csrf
                                            <div class="mb-3">
                                                <label class="form-label" for="card-login">Login</label>
                                                <input class="form-control @error('login') is-invalid @enderror" id="card-login" name="login" type="text"/>
                                                @error('login')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control @error('password') is-invalid @enderror" id="card-password" name="password" type="password"/>
                                                @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
