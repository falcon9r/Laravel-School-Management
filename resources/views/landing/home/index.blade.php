                            ...
                            <div class="banner-info">
                                <div class="container">
                                    <div class="banner-info-bg">
                                        <h5>Добро пожаловать в школу Bolayoqat </h5>
                                        <p class="mt-4 pr-lg-4">
                                            - мы не можем дождаться встречи с вами!
                                        </p>
                                        <a class="btn btn-style btn-primary mt-xl-5 mt-4 mr-2" href="#contact-us">Свяжитесь с нами
                                            <span class="fa fa-chevron-right ml-2" aria-hidden="true"></span>
                                        </a>
{{--                                        <a class="btn btn-style btn-white mt-xl-5 mt-4" href="services.html">--}}
{{--                                            Электронный журнал--}}
{{--                                            <span class="fa fa-chevron-right ml-2" aria-hidden="true"></span>--}}
{{--                                        </a>--}}
                                    </div>
                    ...
                    <li>
                        <div class="slider-info  banner-view banner-top1 bg bg2">
                            <div class="banner-info">
                                <div class="container">
                                    <div class="banner-info-bg">
                                        <h5>В школе Bolayoqat мы верим</h5>
                                        <p class="mt-4 pr-lg-4">
                                            что каждый ученик обладает уникальными талантами и способностями.
                                        </p>
                                        <a class="btn btn-style btn-primary mt-xl-5 mt-4 mr-2" href="#contact-us">Наши достижения
                                            <span class="fa fa-chevron-right ml-2" aria-hidden="true"></span>
                                        </a>
{{--                                        <a class="btn btn-style btn-white mt-xl-5 mt-4" href="services.html">--}}
{{--                                            Электронный журнал--}}
                    ...
                    <li>
                        <div class="slider-info banner-view banner-top2 bg bg2">
                            <div class="banner-info">
                                <div class="container">
                                    <div class="banner-info-bg">
                                        <h5>В школе Bolayoqat мы стремимся</h5>
                                        <p class="mt-4 pr-lg-4">
                                            подготовить наших учеников к успеху в колледже и за его
                                            пределами. </p>
                                        <a class="btn btn-style btn-primary mt-xl-5 mt-4 mr-2" href="#contact-us">Наши учителя
                                            <span class="fa fa-chevron-right ml-2" aria-hidden="true"></span>
                                        </a>
{{--                                        <a class="btn btn-style btn-white mt-xl-5 mt-4" href="services.html">--}}
{{--                                            Электронный журнал--}}
                    ...
                    <li>
                        <div class="slider-info banner-view banner-top3 bg bg2">
                            <div class="banner-info">
                                <div class="container">
                                    <div class="banner-info-bg">
                                        <h5>В школе Bolayoqat мы даем </h5>
                                        <p class="mt-4 pr-lg-4">
                                            учащимся возможность осуществить свою мечту
                                        </p>
                                        <a class="btn btn-style btn-primary mt-xl-5 mt-4 mr-2" href="#contact-us">Рейтинг учащихся
                                            <span class="fa fa-chevron-right ml-2" aria-hidden="true"></span>
                                        </a>
{{--                                        <a class="btn btn-style btn-white mt-xl-5 mt-4" href="services.html">--}}
{{--                                            Электронный журнал--}}
...
{{--                                        </a>--}}
                ...
                <div class="bangrids-inn">
                    <div class="banhny-grid-1">
                        ...
                        <div class="banhny-grid-right-info">
                            <h6><a href="#url">Центр тестирование</a></h6>
                    ...
                    <div class="banhny-grid-1">
                        ...
                        <div class="banhny-grid-right-info">
                            <h6><a href="#url">Личный кабинет</a></h6>
                    ...
                    <div class="banhny-grid-1">
                        ...
                        <div class="banhny-grid-right-info">
                            <h6><a href="#url">Электронная библиотека</a></h6>
                    ...
                    <div class="top-pic1">
                        <div class="card-body blog-details">
                            ...
                            <div class="author align-items-center">
                                <img src="{{ asset('assets/landing/images/admin.jpg') }}" alt="" class="img-fluid rounded-circle">
                                <ul class="blog-meta">
                                    <ul class="blog-meta">
                ...
                <div class="col-lg-3 col-md-6 mt-5">
                    <div class="top-pic2">
                        <div class="card-body blog-details">
                            ...
                            <div class="author align-items-center">
                                <img src="{{ asset('assets/landing/images/admin.jpg') }}" alt=""
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 area-box-info">
                                ...
                                <p class="mt-3">Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices in
                                    ligula. Semper at tempufddfel. Lorem ipsum dolor sit amet.</p>
                                <a class="btn btn-primary btn-style mt-4" href="about.html">Start today <span
                                        class="fa fa-chevron-right ml-2" aria-hidden="true"></span></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-header p-0 position-relative">
                            <a href="blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full"
                                     src="{{ asset('assets/landing/images/ab8.jpg') }}"
                                     alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body blog-details">
                            ...
                            <div class="author align-items-center">
                                ...
                                <ul class="blog-meta">
                                    ...
                                    <li class="meta-item blog-lesson">
                                        <span class="meta-value"> Sep 13, 2020 </span>. <span class="meta-value ml-2"><span
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full"
                                     src="{{ asset('assets/landing/images/ab2.jpg') }}"
                                     alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body blog-details">
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full"
                                     src="{{ asset('assets/landing/images/ab6.jpg') }}"
                                     alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body blog-details">
    ...
    <!--//blog-posts-->
    <!--/w3l-newsletter-->
    <section class="w3l-newsletter" id="contact-us">
        <!-- /form-25-section -->
            ...
            <div class="container py-lg-5">
                <div class="forms-25-info">
                    ...
                    <div class="header-title mb-md-5 mt-4">
                        ...
                        <h3 class="hny-title text-left">Присоединяйтесь к нашему школьному сообществу</h3>
                        <span>Оставьте свои данные мы свяжемся с вами</span>
                    </div>
                    <form action="#" method="post" class="signin-form mt-4 mb-2">
                        <div class="forms-gds">
                            <input type="text" name="" placeholder="Имя" required/>
                            <input type="number" name="" placeholder="Телефон" required/>
                            <button class="btn btn-style btn-primary">Отправить</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div id="owl-demo1" class="owl-two owl-carousel owl-theme mb-md-3 mb-sm-5 mb-4">
                        <div class="item">
                            <div class="testimonial-content">
                                ...
                                <div class="testi-des">
                                    <div class="test-img">
                                        <img src="{{ asset('assets/landing/images/team1.jpg') }}" class="img-fluid"
                                             alt="client-img">
                                    </div>
                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="{{ asset('assets/landing/images/team2.jpg') }}"
                                                               class="img-fluid"
                                                               alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                        ...
                        <div class="item">
                            <div class="testimonial-content">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="{{ asset('assets/landing/images/team3.jpg') }}"
                                                               class="img-fluid"
                                                               alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
